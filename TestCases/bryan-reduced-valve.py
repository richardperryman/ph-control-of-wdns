...
junctions = jncts = (
    pe.Junction(.001,   0, 74.5),
    pe.Junction(.001, 200, 64.7),
    pe.Junction(.001, 300, 60.7),
    pe.Junction(.001, 200, 69.5),
    pe.Junction(.001, 300, 64.4),
    pe.Junction(.001, 300, 60.6),
    pe.Junction(.001, 240, 60),
)
